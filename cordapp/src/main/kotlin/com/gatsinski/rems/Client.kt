...
private class TemplateClient {
    companion object {
        ...
        private fun logState(state: StateAndRef<RealEstate>) = logger.info("{}", state.state.data)
    }
    ...
    fun main(args: Array<String>) {
        ...
        // Can be amended in the com.gatsinski.rems.MainKt file.
        val proxy = client.start("user1", "test").proxy

        // Grab all existing TemplateStates and all future TemplateStates.
        val (snapshot, updates) = proxy.vaultTrack(RealEstate::class.java)
